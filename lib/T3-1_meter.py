#!/usr/bin/python
# T3-1 meterbus type request!!!
# python3 request-data.py -d /dev/ttyUSB0  # debug mode
# python3 request-data.py /dev/ttyUSB0  # debug mode
# needs rewrite from cPython to mPython !!!
